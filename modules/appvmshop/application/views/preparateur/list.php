                    ...
                    <?php 
                        ...
                        foreach($items as $value){
                                ...
                                if($ref != $value->reference){
                                    ...
                                    $html .= '<td><a href="'.base_url('preparateur/order/').$value->reference.'">'.$value->reference.'</a></td>';
                                    ...
                                    $html .= '<td><a href="" class="btn btn-outline-secondary"><i class="far fa-check-square"></i></a></td>';
