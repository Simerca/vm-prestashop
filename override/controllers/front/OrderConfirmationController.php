...
class OrderConfirmationControllerCore extends FrontController
{
    ...
    public function init()
    {
        ...
        if(Db::getInstance()->update('cart_date',array(
        ...
        $sql = 'SELECT * FROM '._DB_PREFIX_.'cart_date
        WHERE id_order = '.$this->id_order.' ORDER BY id DESC';
        if ($row = Db::getInstance()->getRow($sql)){

            $date_retrait = str_replace('/','-',$row['date_retrait']);
            $date_retrait = date('Y-m-d', strtotime($date_retrait));

            if(Db::getInstance()->update('orders',array(
                'date_retrait'=>$date_retrait,
                'heure_retrait'=>$row['heure_retrait'],
                'boutique_retrait'=>$id_shop,
                'boutique_facturation'=>$id_shop
            ), 'id_order = '.$this->id_order)){
        ...
        if(Db::getInstance()->update('users_plate',array(
            'id_order'=>$this->id_order
